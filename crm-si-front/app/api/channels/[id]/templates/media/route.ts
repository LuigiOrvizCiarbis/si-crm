...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const { data, status } = await proxyToLaravel(`/api/channels/${id}/templates/media`, authHeader, {
      method: "POST",
      body: form,
      rawBody: true,
    });
    ...
    console.error("[Proxy] POST /channels/templates/media failed:", error.message);
