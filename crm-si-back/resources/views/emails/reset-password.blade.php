...
<head>
    ...
    <title>Restablece tu contraseña - Social Impulse</title>
    <!--[if mso]>
    <noscript>
        <xml>
                                ...
                                <tr>
                                    <td style="padding: 40px 32px;">
                                            ...
                                            <tr>
                                                <td style="padding: 24px;">
                                                    <p style="color: #e2e8f0; font-size: 15px; line-height: 1.7; margin: 0; text-align: center;">
                                                        Recibimos una solicitud para restablecer la contraseña de tu cuenta en <strong style="color: #0ea5e9;">Social Impulse</strong>. Haz clic en el botón para crear una nueva contraseña.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 auto 32px auto;">
                                            <tr>
                                                <td>
                                                    <a href="{{ $resetUrl }}" style="display: inline-block; background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 600; padding: 16px 48px; border-radius: 12px; box-shadow: 0 4px 14px rgba(139, 92, 246, 0.4);">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p style="color: #94a3b8; font-size: 13px; line-height: 1.6; margin: 0;">
                                                        <strong style="color: #e2e8f0;">¿No solicitaste este cambio?</strong><br>
                                                        Si no pediste restablecer tu contraseña, puedes ignorar este correo de forma segura. Tu contraseña actual seguirá activa.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
